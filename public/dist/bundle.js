...
var designWidth = 375,
    rem2px = 100;if (window.innerWidth < 640) {
...
var draw = window.draw = function () {
    let canvas = document.querySelector('.canvas'),
        ...
        min_temp = document.querySelectorAll('.temp-data li b');
    let diff = [],
        arr = [];
